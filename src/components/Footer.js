        ...
        <div className="flex flex-col gap-12 lg:flex-row">
          ...
          <div className="flex flex-1 flex-col gap-16 lg:flex-row">
            ...
            <div className="text-center w-full lg:text-left">
              ...
              <ul className=" space-y-4 text-gray">
                ...
                <li><a className="hover:text-blue transition" href="">Featurest</a></li>
                <li><a className="hover:text-blue transition" href="">Contact</a></li>
                <li><a className="hover:text-blue transition" href="">Link 5</a></li>

              </ul>
            </div>
            <div className="text-center w-full lg:text-left">
              {/* link group */}
              <div className="text-xl font-medium mb-6">Resourser Links</div>
              <ul className=" space-y-4 text-gray">
                <li><a className="hover:text-blue transition" href="">Dowload Whitepaper</a></li>
                <li><a className="hover:text-blue transition" href="">Smart Token</a></li>
                <li><a className="hover:text-blue transition" href="">Blockchain Exlore</a></li>
          ...
          <div className="flex flex-col flex-1">
            <div className="lg:ml-[80px]">
              <h3 className="h3 font-medium text-center mb-10 lg:text-left">We accept following payment sysytems </h3>
