        ...
        {currency.map((item,index) => {
          ...
          return(
            ...
            <div className='flex flex-col justify-center items-center'>
              ...
              {/* btn */}
              <button className={`${name === itemName ? 'text-white bg-blue hover:bg-blue-hover border-none pl-8 pr-6 gap-x-3' : ' text-blue'}  border-2 border-gray-300 rounded-full h-16 flex justify-center items-center`}> {name === itemName && <div className='text-lg font-medium'
              >
                Start mining
              </div>
              }
