      ...
      <div className='flex flex-col gap-y-6 lg:flex-row lg:justify-between'>
        {/* item */}
         <div className='flex items-center gap-x-6'>
          ...
          {/*  items text */}
          <div>
            <div className='text-3xl font-bold lg:text-[40px] lg:mb-2'>$30B</div>
          ...
          {/*  items text */}
          <div>
            <div className='text-3xl font-bold lg:text-[40px] lg:mb-2'>$10M+</div>
          ...
          {/*  items text */}
          <div>
            <div className='text-3xl font-bold lg:text-[40px] lg:mb-2'>195</div>
            <div className='text-gray'>Countries Supproting </div>
